...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./Assets/cheems.jpg'), `${watermark}`, `${BotName}`, "916909137213@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
switch(command) {
    ...
    teks = `*ZenitsuBot*\n\n*Script*: https://github.com/DGDEEPAK/Zenitsu-Bot\n*YouTube*: https://youtube.com/@dreamguydeepak `
    let buttons = [
...
case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
 ...
 caption: `「  _Deepak Youtube Player 2.0_  」
